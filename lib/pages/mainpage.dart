...
import 'package:app1/constant/text_style.dart';
import 'package:app1/models/event_model.dart';
import 'package:app1/pages/event_detail_page.dart';
import 'package:app1/utils/app_utils.dart';
import 'package:app1/widgets/bottom_navigation_bar.dart';
import 'package:app1/widgets/home_bg_color.dart';
import 'package:app1/widgets/nearby_event_card.dart';
import 'package:app1/widgets/ui_helper.dart';
import 'package:app1/widgets/upcoming_event_card.dart';
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      opacityController.value = offsetToOpacity(
          ...
          maxOffset: scrollController.position.maxScrollExtent / 2) as double;
    });
    super.initState();
  }
